    ...
    class Mysql extends Database\Connector
    {
        ...
        */
        ...
        public function connect()
        {
            ...
            // print("<br>");
            // print('Database\Connector\Mysql\@isConnected = '.($this->isConnected==true?'true':'false')."<br>");
        ...
        public function execute($sql)
        {
            ...
            Events::fire("framework.database.query.before", array($sql));
