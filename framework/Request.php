...
namespace Framework
{
    ...
    class Request extends Base
    {
        ...
        * @readwrite
        */
        protected $_willShareSession = false;
        ...
        */
        ...
        function request($method, $url, $parameters = array())
        {
            ...
            if ($response)
            {
                $result = new Request\Response(array(
                    "response" => $response
                ));
            }
            else
            {
                throw new Exception\Response(curl_error($request));
            }
        ...
        protected function _setRequestOptions($url, $parameters)
        {
            ...
            {
                $this->_setOption(CURLOPT_COOKIE, session_name() . "=" . session_id() . "; path=/");
            }
