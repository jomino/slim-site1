...
class UsersConfirmDefaultController extends \Core\Controller
{
    ...
    public function __invoke($request, $response, $args)
    {
        ...
        switch($args["op"])
        {
            ...
            default:
                $confirm = array(
                    "title" => "Unknow method",
                    "message" => "The {$args["op"]} is not a valid path.",
    ...
    protected function _import()
    {
        ...
        $partial["title"] = "admin.import";
        $partial["message"] = "Attention blabla ...";

        $partial["links"] = $this->_getLinks($router->pathFor("users_import"));
    ...
    protected function _update()
    {
        ...
        $partial["links"] = $this->_getLinks($router->pathFor("users_update"));
    ...
    protected function _delete()
    {
        ...
        $partial["links"] = $this->_getLinks($router->pathFor("users_delete"));
