...
class GeslocpayConfirmDefaultController extends \Core\Controller
{
    ...
    protected function _import()
    {
        ...
        $partial["title"] = "admin.geslocpay_import";
        $partial["message"] = "Attention blabla ...";

        $partial["links"] = $this->_getLinks($router->pathFor("geslocpay_import"));
