...
class GeslochistoConfirmDefaultController extends \Core\Controller
{
    ...
    protected function _import()
    {
        ...
        $partial["title"] = "admin.geslochisto_import";
        $partial["message"] = "Attention blabla ...";

        $partial["links"] = $this->_getLinks($router->pathFor("geslochisto_import"));
