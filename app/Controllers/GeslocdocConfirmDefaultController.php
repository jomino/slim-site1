...
class GeslocdocConfirmDefaultController extends \Core\Controller
{
    ...
    protected function _import()
    {
        ...
        $partial["title"] = "admin.geslocdoc_import";
        $partial["message"] = "Attention blabla ...";

        $partial["links"] = $this->_getLinks($router->pathFor("geslocdoc_import"));
